...
- `01_minimize_Hcal5.txt`  
  Checks positivity of $ℋ_5(\alpha,\beta,\zeta)$ for $\alpha,\beta\in[0,1]$ and $\zeta\in[0,81]$.

- `02_minimize_Qcal5.txt`  
  Checks positivity of $𝒬_5(\alpha,\beta,\zeta)$ for $\alpha,\beta\in[0,1]$ and $\zeta\in[0,81]$.

- `03_minimize_Ptilde.txt`  
  Checks positivity of $\widetilde P(\alpha,\beta,\phi)$ for $\alpha,\beta\in[0,1]$ and $\phi\in[0,\phi_0]$.
